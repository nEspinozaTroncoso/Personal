...
export const RECIPES = [
  ...
  {
    id: "molde-7030-tangzhong",
    name: "Pan de Molde 70/30 con Tangzhong",
    subtitle: "Miga húmeda y duradera, método tangzhong",
    accent: "#8F5A3C",
    totalFlour: 500, // 50 (tangzhong) + 300 (blanca) + 150 (integral)
    ingredients: [
      { id: "harina-blanca-tangzhong", name: "Harina blanca (para el tangzhong)", pct: 10, unit: "g" },
      { id: "liquido-tangzhong", name: "Agua o leche (para el tangzhong)", pct: 50, unit: "ml" },
      { id: "harina-blanca", name: "Harina blanca (000)", pct: 60, unit: "g" },
      { id: "harina-integral", name: "Harina integral", pct: 30, unit: "g" },
      { id: "levadura", name: "Levadura seca instantánea", pct: 1.4, unit: "g" },
      { id: "agua-activacion", name: "Agua tibia (35–40°C, para activar la levadura)", pct: 20, unit: "ml" },
      { id: "azucar", name: "Miel o azúcar", pct: 5, unit: "g" },
      { id: "sal", name: "Sal", pct: 1.8, unit: "g" },
      { id: "grasa", name: "Aceite neutro o mantequilla derretida", pct: 6, unit: "g" },
      { id: "leche-polvo", name: "Leche en polvo (opcional)", pct: 3, unit: "g" },
    ],
    steps: [
      "Prepara el tangzhong: mezcla la harina y el agua o leche del tangzhong en frío hasta que no queden grumos, luego lleva a fuego medio-bajo revolviendo constantemente.",
      "Cocina revolviendo sin parar hasta que espese y forme una pasta tipo pudín (se ven líneas al pasar la cuchara), 2–4 min. Retira del fuego de inmediato.",
      "Pasa el tangzhong a un bowl, cubre con film pegado a la superficie (para que no forme costra) y deja enfriar a temperatura ambiente, 20–25 min.",
      "Mientras enfría, activa la levadura: mezcla el agua tibia con la miel o azúcar, espolvorea la levadura encima y deja reposar 8–10 min hasta que espume.",
      "En un bowl grande mezcla las harinas, la sal y la leche en polvo (si la usas).",
      "Agrega el tangzhong ya tibio, la levadura activada y el aceite o mantequilla. Une hasta masa desordenada.",
      "Amasa 10–12 min. La masa se siente húmeda y pegajosa al inicio pero se vuelve elástica y sedosa rápido — evita agregar harina extra. Debe pasar el test de la ventana.",
      "Primer levado en bowl aceitado y tapado hasta duplicar (con tangzhong suele ser un poco más rápido).",
      "Desgasifica suavemente, estira en rectángulo, enrolla firme y coloca con la unión hacia abajo en el molde enmantequillado.",
      "Segundo levado tapado hasta que sobrepase el molde por 2–3 cm.",
      "Precalienta el horno a 190°C 15 min antes de que termine el levado.",
      "Hornea 35–40 min hasta dorar y sonar hueco al golpear la base. Cubre con papel aluminio si se dora muy rápido arriba.",
      "Desmolda de inmediato y enfría en rejilla al menos 30–40 min antes de cortar.",
    ],
  },
  {
